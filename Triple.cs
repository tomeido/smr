...
public struct Triple
{
    ...
    {
        return "(" + Math.Round(X, decimalDigitsCount) + ", " + Math.Round(X, decimalDigitsCount) + ", " + Math.Round(X, decimalDigitsCount) + ")";
    }
    ...
    {
        return -threshold < X && X < threshold && -threshold < Y && Y < -threshold && -threshold < Z && Z < threshold;
    }

    public static Triple Zero
    {
        get { return new Triple(0f, 0f, 0f); }
    }

    public static Triple One
    {
        get { return new Triple(1f, 1f, 1f); }
    }

    public static Triple BasisX
    {
        get { return new Triple(1f, 0f, 0f); }
    }

    public static Triple BasisY
    {
        get { return new Triple(0f, 1f, 0f); }
    }

    public static Triple BasisZ
    {
        get { return new Triple(0f, 0f, 1f); }
    }
    ...
    {
        return new Triple(a.X * (float)b, a.Y * (float)b, a.Z * (float)b);
    }

    public static Triple operator *(float b, Triple a)
    {
        return new Triple(a.X * b, a.Y * b, a.Z * b);
    }
    ...
    {
        return new Triple(Y * t.Z - Z * t.Y, Z * t.X - X * t.Z, X * t.Y - Y * t.X);
    }
    ...
    {
        return (float)Math.Sqrt((X - t.X) * (X - t.X) + (Y - t.Y) * (Y - t.Y) + (Z - t.Z) * (Z - t.Z));
    }
